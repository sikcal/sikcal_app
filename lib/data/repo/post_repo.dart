...
class PostRepo {
  Post getBestPost() {
    return Post(
      ...
      foodList: [
        Food(foodName: "닭가슴살", carbohydrate: 10, protein: 30, fat: 2, totalKcal: 250),
        Food(foodName: "토마토", carbohydrate: 10, protein: 30, fat: 2, totalKcal: 100),
        Food(foodName: "계란", carbohydrate: 10, protein: 30, fat: 2, totalKcal: 120),
        Food(foodName: "발아현미", carbohydrate: 10, protein: 30, fat: 2, totalKcal: 130),
      ],
      numOfLikes: 275,
